...
#define DEFAULT_MYSQL_HOME "/data/mysql/basedir"
#define SHAREDIR "/data/mysql/basedir/share"
#define DEFAULT_BASEDIR "/data/mysql/basedir"
#define MYSQL_DATADIR "/data/mysql/datadir"
#define DEFAULT_CHARSET_HOME "/data/mysql/basedir"
#define PLUGINDIR "/data/mysql/basedir/lib/plugin"
#define DEFAULT_SYSCONFDIR "/data/mysql/basedir/etc"
